...
spiceprefix=X
m=1}
C {pdks/gf180mcuD/libs.tech/xschem/symbols/sc_diode.sym} -290 30 0 0 {name=D1
model=sc_diode
r_w=2u
r_l=.62u
m=1}
C {pdks/gf180mcuD/libs.tech/xschem/symbols/sc_diode.sym} -60 30 0 0 {name=D2
model=sc_diode
r_w=2u
r_l=.62u
m=1}
C {pdks/gf180mcuD/libs.tech/xschem/symbols/sc_diode.sym} 140 30 0 0 {name=D3
model=sc_diode
r_w=2u
r_l=.62u
m=1}
C {pdks/gf180mcuD/libs.tech/xschem/symbols/sc_diode.sym} 630 30 0 0 {name=D4
model=sc_diode
r_w=2u
r_l=.62u
m=1}
